...
public class Reel extends JFrame {
	...
	public Reel(){
		...
		lblCoins.setFont(new Font("Tahoma", 1, 12));
		...
		lblBets.setFont(new Font("Tahoma", 1, 12));
		lblBets.setForeground(Color.DARK_GRAY);
		...
		reel1.setBorder(new LineBorder(Color.WHITE,10));
		reelPanel.add(reel1);
		reel1.setIcon(imgR1);
		reel2 = new JButton(imgR2);
		reel2.setBorder(new LineBorder(Color.WHITE,10));
		reel2.setIcon(imgR2);
		reelPanel.add(reel2);
		reel3 = new JButton(imgR3);
		reel3.setBorder(new LineBorder(Color.WHITE,10));
		reel3.setIcon(imgR3);
		reelPanel.add(reel3);
		...
		btAddCoin.setBorder(new LineBorder(Color.BLACK,5));
		buttonPanel.add(btAddCoin);
		btBetOne = new JButton("Bet One");
		btBetOne.setBorder(new LineBorder(Color.WHITE,5));
		buttonPanel.add(btBetOne);
		btBetMax = new JButton("Bet Max");
		btBetMax.setBorder(new LineBorder(Color.BLACK,5));
		buttonPanel.add(btBetMax);
		btReset = new JButton("Reset");
		btReset.setBorder(new LineBorder(Color.WHITE,5));
		buttonPanel.add(btReset);
		btSpin = new JButton("Spin");
		btSpin.setBorder(new LineBorder(Color.BLACK,5));
		buttonPanel.add(btSpin);
		btStatistics = new JButton("Statistics");
		btStatistics.setBorder(new LineBorder(Color.WHITE,5));
		...
		lblMessage.setBorder(new LineBorder(Color.BLACK,2));
		lblMessage.setFont(new Font("Tahoma", 1, 20));
